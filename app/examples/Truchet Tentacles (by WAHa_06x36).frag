// Author: WAHa_06x36
// Source: https://www.shadertoy.com/view/ldfGWn
//
// License: http://creativecommons.org/licenses/by-nc-sa/4.0
// 			see also: https://www.shadertoy.com/terms
//
// Modifications:
//
// - added 'mainVR' entry point
// - removed cube map sampling
// - added a very simple procedural environment map
...
void mainVR( out vec4 fragColor,
		in vec2 fragCoord, in vec3 ray_pos, in vec3 ray_dir ) {
...
#else
    // substitute procedural envmap to run without textures
	float env = dot( reflected, vec3( -3., 4., -1. ) );
    env = clamp( env * env  * .2 - 1.5, 0., 1. );
#endif
